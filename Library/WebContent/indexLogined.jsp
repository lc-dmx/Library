...
<%@page import="cn.cumt.library.form.PostForm" errorPage="errorPage.jsp"%>
...
#head {
	...
	background: -webkit-gradient(linear, 0 0, 0 100%, from(#CCFFCC),
		to(#99CCFF));
...
<%
	...
	<!--正文内容  -->
	<jsp:include page="userTop.jsp" flush="true" />	
	...
	PostForm postForm1 = (PostForm) postList.get(0);
			...
			<div class="col-xs-6 col-md-3">
				...
				<div class="collapse" id="collapse1">
					<div class="well">
						<p>
							<a href="postAction.do?action=4&postId=<%=postForm1.getPostId() %>"><%=postForm1.getPostTitle() %></a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-6 col-md-3">
				...
				<div class="collapse" id="collapse2">
					<div class="well">
						<p>
							<a href="postAction.do?action=4&postId=<%=postForm2.getPostId() %>"><%=postForm2.getPostTitle() %></a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-6 col-md-3">
				...
				<div class="collapse" id="collapse3">
					<div class="well">
						<p>
							<a href="postAction.do?action=4&postId=<%=postForm3.getPostId() %>"><%=postForm3.getPostTitle() %></a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-6 col-md-3">
				...
				<div class="collapse" id="collapse4">
					<div class="well">
						<p>
							<a href="postAction.do?action=4&postId=<%=postForm4.getPostId() %>"><%=postForm4.getPostTitle() %></a>
						</p>
					</div>
				</div>
			</div>
