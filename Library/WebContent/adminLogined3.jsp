			...
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-1 col-sm-8 col-sm-offset-1">
					...
					<table class="table" id="table_3">
						...
						<jsp:include page="table_3.jsp" flush="true" />
					</table>
					<div id="div3">
						<input type="button" onclick="first3()" value="首页"/>
						<input type="button" id="previous3" onclick="previous3()" value="上一页"/>
						第<input type="text" id="page3" size="3"/>页
						<input type="button" id="next3" onclick="next3()"  value="下一页"/>
						<input type="button" onclick="last3()" value="尾页"/>
						共<label id="total3">0</label>条记录
						共<label id="pageCount3">0</label>页	
					</div>
				</div>
			</div>	
		</div>
