			...
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-1 col-sm-8 col-sm-offset-1">
					...
					<table class="table" id="table_2">
						...
						<jsp:include page="table_2.jsp" flush="true" />
					</table>
					<div id="div2">
						<input type="button" onclick="first2()" value="首页"/>
						<input type="button" id="previous2" onclick="previous2()" value="上一页"/>
						第<input type="text" id="page2" size="3"/>页
						<input type="button" id="next2" onclick="next2()"  value="下一页"/>
						<input type="button" onclick="last2()" value="尾页"/>
						共<label id="total2">0</label>条记录
						共<label id="pageCount2">0</label>页
					</div>
				</div>
			</div>	
		</div>
